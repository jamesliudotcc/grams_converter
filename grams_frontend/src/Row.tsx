...
interface Conversion { value: number, label: string }
...
const convert: (input: Input, unit: Unit, conversion: Conversion, scale: number) => string = (input: Input, unit: Unit, conversion: Conversion, scale: number) => {
